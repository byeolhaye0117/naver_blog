      ...
      {list.length === 0 ? (
        ...
        <>
          ...
          <p className="muted mt-3 text-[11px] leading-relaxed">
            ...
            <br />
            {/*
              회원이 정한 기준 (2026-08-21): "일단 지금 실행하고 있지 않은 네이버 정책은 반영하지 말고."
              계기는 「신뢰도 중심 통합 랭킹 모델」 공지 — A/B 테스트 단계였다. lib/naver/notice.ts 주석 참고.
            */}
            <b>예고·시범·A/B 테스트 단계는 규칙으로 옮기지 않습니다.</b> 아직 적용 전인 정책을 규칙으로 만들면
            지금 순위에 아무 일도 안 하는 문장으로 글이 바뀝니다. 목록에 남겨두고, 실제로 순위가 움직이는 것이
            보이면 그때 적으세요.
            <br />

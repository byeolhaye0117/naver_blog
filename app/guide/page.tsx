      ...
      <div className="space-y-4">
        ...
        >
            ...
            <table className="w-full min-w-[520px] text-[12px]">
              ...
              <tbody>
                {[
                  ...
                  ['상호명 반복', '「저희 ○○점에서는」', '— (안 쟀음)'],
                  ['홍보 낱말', '상담 · 예약 · 문의 · 등록', '— (2026-08-21 추가)'],
          ...
          <p className="mt-3 text-[12px] leading-relaxed">
            ...
            그래서 정보글에서 <strong>예약 링크·상담 유도·마지막 센터 소개 구간을 뺐습니다.</strong> (인사와 상호명 1회는 08-21에 되살렸습니다 — 아래 참고.){' '}
          ...
          */}
          <div className="mt-3 rounded-xl border border-sky-500/30 bg-sky-500/8 px-3.5 py-3 text-[12px] leading-relaxed text-sky-900 dark:text-sky-200">
            ...
            <p className="mt-1.5">
              ...
              <br />
              <br />
              <strong>그리고 업체명도 인사에 한 번 넣습니다</strong> (2026-08-21 추가 요청). 다시 보니 여섯 가지 중{' '}
              <strong>상호명만 저희가 실측한 적이 없었습니다</strong> — 위 표에서 상호명 칸만 「—」인 이유입니다.
              나머지 다섯은 1페이지 정보형 38편에서 실제로 셌고요. 저희가 잰 것은 오히려 반대쪽이었습니다(상호명
              유무로 순위 차이 없음 · 홍보 신호 0종류인 글이 1~3위 15%로 가장 낮음).
              <br />
              그래서 인사 형식을 이렇게 정했습니다(회원님이 지정하신 문형입니다):
            </p>
            <p className="bd mt-2 rounded-lg border bg-white/50 px-3 py-2 text-[12px] leading-relaxed dark:bg-black/20">
              안녕하세요, <strong>(메인 키워드)</strong> <strong>(정식 상호명)</strong>입니다. 오늘은{' '}
              <strong>(이 글의 주제)</strong>에 대해 소개해드리려고 합니다.
            </p>
            <p className="mt-2">
              영상이 말한 것은 「과도한 반복」이지 한 번 밝히는 것이 아닙니다 — <strong>본문에서 1회까지</strong>이고,
              2회부터는 검수가 잡습니다. <strong>제목에는 넣지 않습니다</strong>(제목 앞자리는 정보 키워드 자리입니다).
              이 두 문장에 메인 키워드가 들어가므로 <strong>첫 100자 조건도 여기서 끝납니다.</strong>
            </p>
          </div>

          {/*
            회원 지적 (2026-08-21): "정보성에는 홍보문구가 아예 들어가면 안돼 상담도 홍보문구잖아
            알고 있는거지?" — 맞고, 우리 코드가 이미 CTA_WORDS 로 그렇게 세고 있었다.
          */}
          <div className="mt-3 rounded-xl border border-rose-500/30 bg-rose-500/8 px-3.5 py-3 text-[12px] leading-relaxed text-rose-900 dark:text-rose-200">
            <strong className="font-bold">「상담」도 홍보 문구입니다 (2026-08-21).</strong>
            <p className="mt-1.5">
              회원님 지적이 맞았고, 사실 <strong>저희 코드가 이미 그렇게 세고 있었습니다</strong> — 홍보글의 순위
              신호를 잴 때 「상담·예약·문의」 횟수를 셉니다. 그런데 정보글에서만 「제가 상담하면서 보면」을 예외로
              뒀었습니다. <strong>같은 낱말을 한쪽에선 홍보 신호로 세면서 다른 쪽에선 아니라고 한 셈</strong>입니다.
              <br />
              이제 정보글에는 <strong>상담 · 예약 · 문의 · 등록 · 회원권 · 이용권 · 이벤트 · 할인 · 무료 · 혜택이
              하나도 들어가지 않습니다.</strong> 검수가 낱말 단위로 잡습니다.
              <br />
              대신 현장 근거를 대는 말은 살렸습니다 — 「제가 상담할 때」(X) →{' '}
              <strong>「수업하다 보면」·「회원분들 보면」·「운동 배우러 오시는 분들 얘기를 들어보면」</strong>(O). 정보글이
              현장을 근거로 쓰는 건 그대로입니다.
            </p>
          </div>

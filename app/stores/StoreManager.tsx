  ...
  return (
    ...
    >
      <div className="space-y-2.5">
        ...
        {/*
          **자동으로 다 못 긁는다는 사실을 여기 적는다** (2026-08-19).
          회원이 물었다 — "나머지 6건은 왜 못 읽어와?" 트레이너 예약 상품 리뷰 13건 중 7건만
          읽혔다. 서버가 HTML 에 첫 페이지(7건)만 담아 보내고, 나머지는 화면에서 스크롤할 때
          자바스크립트가 따로 불러온다. 그 통로(플레이스 GraphQL)는 서버 IP 에 캡차를 준다.
          그러니 「왜 안 되나」를 회원이 물어보게 만들지 말고, 여기서 미리 밝혀 둔다.
        */}
        <div className="bd rounded-xl border px-3 py-2 text-[11.5px] leading-relaxed">
          <b>트레이너별 PT 리뷰도 여기 붙여넣으면 됩니다.</b> 예약 상품(「○○ 트레이너 상담 / 무료체험
          신청하기」)에 달린 리뷰가 그것입니다 — 효과·트레이너 걱정에 답할 때 가장 쓸모 있는 문장들이
          거기 있습니다.
          <br />
          <span className="muted">
            앱이 자동으로 가져오는 데는 한계가 있습니다. 네이버는 첫 화면분만 서버에서 내려주고 나머지는
            스크롤할 때 불러오는데, 그 통로는 서버에서 부르면 캡차로 막습니다. 그래서 <b>스크롤을 끝까지
            내린 뒤 전체 선택·복사</b>가 가장 확실합니다.
          </span>
        </div>

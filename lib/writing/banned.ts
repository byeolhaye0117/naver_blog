...
export const RISK_TERMS: RiskTerm[] = [
  ...
  { pattern: '무조건|절대로|절대\\s|확실히|반드시\\s*빠', category: 'A. 최상급·단정', level: 'fail', fix: '삭제하고 이유·과정을 설명하는 문장으로 바꾸세요' },
  ...
  { pattern: '확실히\\s*빠|누구나\\s*(살|체중)|무조건\\s*빠|살\\s*빠지는\\s*방법', category: 'B. 효과 보장', level: 'fail', fix: '삭제 → 어떤 과정으로 돕는지 설명으로 대체' },
  ...
  { pattern: '치료|완치|낫는다|낫습니다|치유', category: 'C. 의료·치료성', level: 'fail', fix: '"치료"라는 단어 자체를 쓰지 않습니다. "몸이 불편하신 분도 무리 없는 강도부터 시작하도록 안내해드립니다"' },

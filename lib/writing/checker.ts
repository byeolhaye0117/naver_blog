      ...
      hint: titlePromo
        ...
        : (input.type === 'review'
          ...
          (ev
            ...
            : '이벤트 칸이 비어 있으면 **금액 없이 쓸 수 있는 말**로 넣으세요 — 「가격」·「비용」·「얼마」·「이용권」·「체험」. 예) 「쌍용동 헬스장 가격 궁금해서 상담 받아본 후기」. 없는 금액을 만들 필요는 없습니다. 다만 「상담 받아본 후기」·「등록한 후기」만으로는 홍보 조각으로 세지 않습니다 — 후기 제목에 거의 다 들어가는 말이라 구별이 되지 않습니다.') +
          ' 실측에서 제목에 홍보성이 있는 글이 불리하지 않았습니다 (있음 1~3위 36% / 없음 29%). 다만 「최저가·파격가·반값」은 광고심의 위험이라 쓰지 않습니다.',
      /*
